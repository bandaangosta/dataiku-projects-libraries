...
class DataFetch():
    ...
    def prepareMetadata(self, plotData, daysBack):
        now = datetime.now()
        strEndDate = DateTools.dateToStr(now)
        strStartDate = DateTools.GetDateStringDelta(now, daysBack)
    ...
    def getData(self, plotData, daysBack=1):        
        self.prepareMetadata(plotData, daysBack)
